...
public class CaseInsensitiveLinkedHashMap<V> extends LinkedHashMap<String, V> {
    ...
    public CaseInsensitiveLinkedHashMap(boolean useOriginalKey) {
    ...
    public CaseInsensitiveLinkedHashMap(Locale locale, boolean useOriginalKey) {
    ...
    public CaseInsensitiveLinkedHashMap(int initialCapacity, boolean useOriginalKey) {
        this(initialCapacity, null, useOriginalKey);
    }

    public CaseInsensitiveLinkedHashMap(int initialCapacity, Locale locale) {
        this(initialCapacity, locale, false);
    }

    public CaseInsensitiveLinkedHashMap(int initialCapacity, Locale locale, boolean useOriginalKey) {
